		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assets/img/petty.jpg" height="40px"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i><?php echo $userRow['patientLastName']; ?><b class="caret"></b></a>
					...
					<div class="row">
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								<img src="assets/img/petlove.png" class="img-responsive" />
								<div class="description">
									<h4> <?php echo $userRow['patientLastName']; ?></h4>
									<h5> <strong> Welcome! Your Profile </strong></h5>
						...
						<div class="col-md-9 col-sm-9  user-wrapper">
							<div class="description">
								<h3> <?php echo $userRow['patientFirstName']; ?></h3>
								<hr />
										...
										<form action="<?php $_PHP_SELF ?>" method="post" >
											<table class="table table-user-information">
												<tbody>
													...
													<tr>
														<td>First Name:</td>
														<td><input type="text" class="form-control" name="PetName" value="<?php echo $userRow['patientFirstName']; ?>"  /></td>
													</tr>
													<tr>
														<td>Last Name</td>
														<td><input type="text" class="form-control" name="OwnerName" value="<?php echo $userRow['patientLastName']; ?>"  /></td>
													</tr>
