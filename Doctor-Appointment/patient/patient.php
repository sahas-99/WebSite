...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assets/img/8accd1d578edf1a3c1fb1d334d3ed205.png" height="35px" ></a>
				</div>
				...
				<div class="row">
					<div class="col-xs-12 col-md-8">
						...
						echo "<div class='row'>";
							...
							?>
							<!-- notification end -->
							<h2 style="color: red">Hai! <?php echo $userRow['patientLastName']; ?>. Make appointment today!</h2>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">© PetCity - Veterinary Service</p>
				<p class="pull-right small">Care <i class="fa fa-heart pomegranate"></i> Your Pet</p>
			</div>
		</div>
		<!-- footer end -->
